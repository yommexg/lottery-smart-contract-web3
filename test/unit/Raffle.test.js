  ...
  : describe("Raffle Unit Test", () => {
      ...
      describe("constructor", () => {
        it("initializes the raffle correctly", async () => {
          // Ideally, we shuld have one assert per it for our tests.
      ...
      describe("checkUpKeep", () => {
        ...
        it("returns false if raffle is not opened", async () => {
          await raffle.enterRaffle({ value: raffleEntranceFee });
          await network.provider.send("evm_increaseTime", [
            interval.toNumber() + 1,
          ]);
      ...
      describe("fufilRandomWords", () => {
        ...
        it("picks a winner, reset the lottery, and sends money", async () => {
          ...
          // We need to wait for fulfill random words to be called.
          await new Promise(async (resolve, reject) => {
            ...
            const winnnerStartingBalance = await accounts[1].getBalance();
